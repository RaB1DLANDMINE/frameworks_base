    ...
    abstract class VisibilityBoundsTransition(logBuffer: LogBuffer) : Transition() {
        ...
        override fun createAnimator(
            ...
            val isCustomClockEnabled = Settings.Secure.getIntForUser(
                to.view.context.contentResolver,
            ...
            fun assignAnimValues(
                ...
                val finalAlpha = if (isCustomClockEnabled && to.view.id == ClockViewIds.LOCKSCREEN_CLOCK_VIEW_SMALL) {
                    0f
                } else {
                    alpha
                }

            ...
            new ViewPager.SimpleOnPageChangeListener() {
                ...
                public void onPageScrollStateChanged(int state) {
                    if (state != mCurrentScrollState && state == SCROLL_STATE_IDLE) {
                        ...
                        for (int i = 0; i < mPages.size(); i++) {
                            mPages.get(i).setLayerType(View.LAYER_TYPE_NONE, null);
                        }
                    } else if (state != mCurrentScrollState && state != SCROLL_STATE_IDLE) {
                        for (int i = 0; i < mPages.size(); i++) {
                            mPages.get(i).setLayerType(View.LAYER_TYPE_HARDWARE, null);
                        }
                    }
